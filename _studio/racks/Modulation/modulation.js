	...
	'/_studio/Modules/CustomModulators/ModulatorAudibleRange/ModulatorAudibleRange.js'
		...
		return {
			...
			description : 'This rack shows modulation and trigger nodes (LFO and Envelope Generator).'
				...
				+'<br/>2. Connect the control out of an LFO to the control in of an Osc to get vibrato/frequency modulation'
				+'<br/>3. Connect the control out of an LFO to the control in of a Filter to get wah-wah'
				+'<br/>4. Connect the control out of an LFO to the control in of an Amp to get tremolo'
