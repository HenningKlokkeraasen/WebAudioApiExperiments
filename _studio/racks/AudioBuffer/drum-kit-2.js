		...
		return {
			...
			rackData : {
				rows : [
					{
						modules: [
							{ moduleMother: AudioFilePlayer, id: 'drumpads2' }
						]
					},
					{
						modules: [
				...
				patches : [
					{ from : 'drumpads2', to: 'audiodestination1', type: 'audio' },
					{ from: 'drumpads2', to: 'analyser1', type: 'audio' },
					{ from: 'drumpads2', to: 'analyser2', type: 'audio' }
				]
			},
		};
	}
