		...
		return {
			...
			rackData : {
				rows : [
					{
						modules: [
							{ moduleMother: AudioFilePlayer, id: 'drumpads3' }
						]
					},
					{
						modules: [
				...
				patches : [
					{ from : 'drumpads3', to: 'audiodestination1', type: 'audio' },
					{ from: 'drumpads3', to: 'analyser1', type: 'audio' },
					{ from: 'drumpads3', to: 'analyser2', type: 'audio' }
				]
			},
		};
	}
